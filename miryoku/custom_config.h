...
#define MIRYOKU_KLUDGE_TOPROWCOMBOS_LEFTPINKIE 14 15
#define MIRYOKU_KLUDGE_TOPROWCOMBOS_LEFTINNERINDEX 15 16
#define MIRYOKU_KLUDGE_TOPROWCOMBOS_RIGHTINNERINDEX 22 23
#define MIRYOKU_KLUDGE_TOPROWCOMBOS_RIGHTPINKIE 23 24
